    ...
    <el-dialog title="编辑" :visible.sync="dialogFormVisible">
      ...
      <el-form :model="userInfo" ref="usrInfo" :rules="rules" label-width="100px"
        ...
        <el-form-item label="权限" prop="userName" class="custom-form-item">
          <el-select :loading="Power_Loading" :disabled="!show_upd_btn" v-model="userInfo.power" placeholder="请选择">
            <el-option
        ...
        <el-form-item label="审批" prop="userName" class="custom-form-item">
          <el-select :loading="SP_Loading" :disabled="!show_upd_btn" v-model="userInfo.shenpi" placeholder="请选择">
            <el-option
...
export default {
  ...
  methods: {
    ...
    submitForm(formName) {
      ...
      this.login_btn_loading = true;
      console.log("更新表单：", this.userInfo)
      this.$refs[formName].validate((valid) => {
        if (valid) {
