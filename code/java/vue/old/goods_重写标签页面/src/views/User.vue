    ...
    <el-container style="height: 100%;">
      ...
      <el-main>
        ...
        >
          ...
          <el-table-column prop="cfenl" label="客户分类"> </el-table-column>
          <el-table-column prop="cboss" label="上级单位"> </el-table-column>
          <el-table-column prop="clevel" label="客户等级"> </el-table-column>
          <el-table-column prop="clevel" label="价格等级"> </el-table-column>
          <el-table-column prop="cregion" label="所在地区"> </el-table-column>
          <el-table-column prop="caddress" label="地址"> </el-table-column>
          <el-table-column prop="ctext" label="备注"> </el-table-column>
