...
export default {
  ...
  methods: {
    ...
    addUser() {
      ...
      let url = "http://user-20200618gm:8102/gongYingShang/selectMaxDanHao"
    ...
    updUser() {
      ...
      let url = "http://user-20200618gm:8102/gongYingShang/selectById"
    ...
    query(){
      ...
      let url = "http://user-20200618gm:8102/gongYingShang/queryList"
    ...
    saveGongYingShang(){
      ...
      let url = "http://user-20200618gm:8102/gongYingShang/gongyingshangAdd"
      this.axios.post(url, {
    ...
    updGongYingShang(){
      var save_list = this.gongYingShang
      let url = "http://user-20200618gm:8102/gongYingShang/gongyingshangUpd"
      this.axios.post(url, {
        "head":this.gongYingShang,
        "body":this.gongYingShang.body
      }).then(res => {
    ...
    deleteClick(){
      ...
      this.$confirm('是否删除当前选中的信息?', '提示', {
        ...
        console.log(list)
        let url = "http://user-20200618gm:8102/gongYingShang/delGongYingShang";
