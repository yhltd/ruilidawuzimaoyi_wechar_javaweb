...
export default {
  ...
  methods: {
    ...
    kaipiao_add(){
      ...
      let url = "http://localhost:8102/caiGouDingDan/xiangQingXuKaiPiao"
    ...
    kaipiaoSure(){
      ...
      let url="http://localhost:8102/shouPiao/shouPiaoListAdd"
    ...
    seeList(row){
      this.p_id = row.id
      let url = "http://localhost:8102/caiGouDingDan/selectXiangQingById"
