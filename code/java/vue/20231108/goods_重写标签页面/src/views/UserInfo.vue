  ...
  methods: {
    ...
    addFormSub(formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          let URL = "http://user-20200618gm:8102/user/useradd";
          axios.post(
    ...
    deleteUsers() {
      ...
      this.$confirm('是否删除当前选中的信息?', '提示', {
        ...
        let url = "http://user-20200618gm:8102/user/delUsers";
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          let URL = "http://user-20200618gm:8102/user/updUsrInfo";
          axios.post(
              URL, info, true
          ).then(res => {
            switch (res.data.code) {
    ...
    queryPowers() {
      ...
      let url = "http://user-20200618gm:8102/userpower/queryPower";
    ...
    queryShenPis() {
      ...
      let url = "http://user-20200618gm:8102/user/queryShenpis";
    ...
    queryUsersInfo() {
      let url = "http://user-20200618gm:8102/user/queryAllUsers";
      axios.post(url).then(res => {
        switch (res.data.code) {
          case '00':
            this.tableData = res.data.data;
