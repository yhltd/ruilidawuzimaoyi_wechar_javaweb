...
<!--          ztt 开票信息关联-->
    ...
    <el-dialog title="" :visible.sync="fileDialog" width="80%">
      ...
      <el-row :gutter="15">
        <el-col :span="3">
          <el-button type="primary" :loading="downloadLoading" @click="upload()"><i class="el-icon-folder-add"></i>文件上传</el-button>
        </el-col>
      </el-row>
...
//ztt end
    ...
    save(){
      ...
      if(this.gongYingShang.id != undefined && this.gongYingShang.id != null){
        ...
        let url = "http://yhocn.cn:8102/customer/getChongFu";
        axios.post(url, {
