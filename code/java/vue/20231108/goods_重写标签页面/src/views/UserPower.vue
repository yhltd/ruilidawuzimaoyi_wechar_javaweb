...
export default {
  ...
  methods: {
    ...
    updUser() {
      ...
      let url = "http://user-20200618gm:8102/userpower/queryUserPowerById"
    ...
    savePower(){
      ...
      let url = "http://user-20200618gm:8102/userpower/powerAdd"
    ...
    updPower(){
      ...
      var save_list = this.Power
      let url = "http://user-20200618gm:8102/userpower/powerUpd"
      this.axios.post(url, save_list).then(res => {
        if(res.data.code == '00') {
          console.log(res)
          MessageUtil.success(res.data.msg);
    ...
    deleteClick(){
      ...
      this.$confirm('是否删除当前选中的信息?', '提示', {
        ...
        console.log(list)
        let url = "http://user-20200618gm:8102/userpower/delPower";
