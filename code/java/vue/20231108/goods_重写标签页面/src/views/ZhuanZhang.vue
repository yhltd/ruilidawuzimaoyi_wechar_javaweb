...
<!--          <el-input ref="acc_inp" v-model="ZhuanZhang.riqi" class="custom-login-inp" ></el-input>-->
        ...
        <el-form-item label="转入账户" prop="zhuanru" class="custom-form-item">
          <el-select style="z-index:999;" v-model="ZhuanZhang.zhuanru" clearable filterable placeholder="请选择">
            <!-- types 为后端查询 -->
            <el-option
                v-for="item in XiaLa_ZhangHu"
                :key="item.name"
...
<!--          <el-input ref="acc_inp" v-model="ZhuanZhang.zhuanru" class="custom-login-inp" ></el-input>-->
        ...
        <el-form-item label="转出账户" prop="zhuanchu" class="custom-form-item">
          <el-select style="z-index:999;" v-model="ZhuanZhang.zhuanchu" clearable filterable placeholder="请选择">
            <!-- types 为后端查询 -->
            <el-option
                v-for="item in XiaLa_ZhangHu"
                :key="item.name"
        ...
        <el-form-item label="摘要" prop="zhaiyao" class="custom-form-item">
          ...
          <el-row :gutter="15">
            ...
            <el-col :span="4">
              <div style="display: flex">
                <el-button class="custom-login-button" :loading="login_btn_loading" type="primary"
                           @click="addClose" style="margin-left: 40px"><i class="el-icon-circle-close"></i>取消
                </el-button>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    updUser() {
      ...
      let url = "http://yhocn.cn:8102/zhuanZhang/selectZhuanZhangById"
    ...
    getAll(){
      ...
      let url = "http://yhocn.cn:8102/zhuanZhang/getAll"
    ...
    queryList(){
      ...
      let url = "http://yhocn.cn:8102/zhuanZhang/queryList"
    ...
    saveGongYingShang(){
      ...
      let url = "http://yhocn.cn:8102/zhuanZhang/zhuanZhangAdd"
    ...
    updGongYingShang(){
      var save_list = this.ZhuanZhang
      let url = "http://yhocn.cn:8102/zhuanZhang/zhuanZhangUpd"
      this.axios.post(url, save_list).then(res => {
        if(res.data.code == '00') {
          console.log(res)
          MessageUtil.success(res.data.msg);
    ...
    deleteClick(){
      ...
      this.$confirm('是否删除当前选中的信息?', '提示', {
        ...
        console.log(list)
        let url = "http://yhocn.cn:8102/zhuanZhang/delZhuanZhang";
