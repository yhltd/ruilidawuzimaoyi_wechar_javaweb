...
export default {
  ...
  methods: {
    ...
    selectProduct(){
      ...
      if(this.gongYingShang.danjuLeixing == '采购订单'){
        this.getCaiGouProduct()
      }else if(this.gongYingShang.danjuLeixing == '采购入库'){
        this.getRuKuProduct()
    ...
    //查询窗口table中的内容列表
    getCaiGouProduct(){
      let url = "http://user-20200618gm:8102/caiGouDingDan/selectWeiFu"
      this.axios.post(url,{}).then(res => {
        if(res.data.code == '00') {
    ...
    getRuKuProduct(){
      let url = "http://user-20200618gm:8102/caiGouRuKu/selectWeiFu"
      this.axios.post(url,{}).then(res => {
        if(res.data.code == '00') {
          this.CaiGou_Product = res.data.data;
          console.log(this.CaiGou_Product)
    ...
    //查询全部
    getAll(){
      let url = "http://user-20200618gm:8102/shouZhiMingXi/getZhiChu"
    ...
    //查询全部
    getAllByName(){
      let url = "http://user-20200618gm:8102/shouZhiMingXi/getZhiChuByName"
    ...
    queryList(){
      ...
      let url = "http://user-20200618gm:8102/shouZhiMingXi/queryZhiChuList"
    ...
    queryListByName(){
      ...
      let url = "http://user-20200618gm:8102/shouZhiMingXi/queryZhiChuListByName"
      this.axios.post(url, date).then(res => {
        if(res.data.code == '00') {
          this.tableData = res.data.data;
          this.total = res.data.data.length;
