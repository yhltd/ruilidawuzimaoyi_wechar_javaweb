...
export default {
  ...
  methods: {
    ...
    addUser() {
      ...
      let url = "http://user-20200618gm:8102/shouZhiMingXi/selectMaxDanHao"
    ...
    updUser() {
      ...
      let url = "http://user-20200618gm:8102/shouZhiMingXi/selectById"
    ...
    //查询窗口table中的内容列表
    getCaiGouProduct(){
      let url = "http://user-20200618gm:8102/xiaoShouDingDan/selectWeiFu"
      this.axios.post(url,{}).then(res => {
        if(res.data.code == '00') {
    ...
    getRuKuProduct(){
      let url = "http://user-20200618gm:8102/xiaoShouChuKu/selectWeiFu"
      this.axios.post(url,{}).then(res => {
        if(res.data.code == '00') {
          this.CaiGou_Product = res.data.data;
          console.log(this.CaiGou_Product)
    ...
    //读取下拉列表
    getXiaLa_User(){
      let url = "http://user-20200618gm:8102/user/getall"
    ...
    //查询全部
    getAll(){
      let url = "http://user-20200618gm:8102/shouZhiMingXi/getShouRu"
    ...
    //查询全部
    getAllByName(){
      let url = "http://user-20200618gm:8102/shouZhiMingXi/getShouRuByName"
    ...
    queryList(){
      ...
      let url = "http://user-20200618gm:8102/shouZhiMingXi/queryShouRuList"
    ...
    queryListByName(){
      ...
      let url = "http://user-20200618gm:8102/shouZhiMingXi/queryShouRuListByName"
      this.axios.post(url, date).then(res => {
        if(res.data.code == '00') {
          this.tableData = res.data.data;
          this.total = res.data.data.length;
    ...
    saveGongYingShang(){
      ...
      let url = "http://user-20200618gm:8102/shouZhiMingXi/shouzhiAdd"
      this.axios.post(url, {
    ...
    updGongYingShang(){
      var save_list = this.gongYingShang
      let url = "http://user-20200618gm:8102/shouZhiMingXi/shouzhiUpd"
      this.axios.post(url, {
        "head":this.gongYingShang,
        "body":this.gongYingShang.body
      }).then(res => {
    ...
    deleteClick(){
      ...
      this.$confirm('是否删除当前选中的支出信息?', '提示', {
        ...
        console.log(list)
        let url = "http://user-20200618gm:8102/shouZhiMingXi/delShouZhi";
