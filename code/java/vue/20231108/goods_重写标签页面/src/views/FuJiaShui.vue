        ...
        <el-row :gutter="15">
          ...
          <el-col :span="6">
            <el-form-item label="等级" prop="gongyingshangDengji" class="custom-form-item">
              <el-select v-model="gongYingShang.gongyingshangDengji" filterable placeholder="请选择等级">
                <!-- types 为后端查询 -->
                <el-option
...
<!--              <el-input ref="acc_inp" v-model="gongYingShang.gongyingshangDengji" class="custom-login-inp"></el-input>-->
          ...
          <el-col :span="6">
            <el-form-item label="采购员" prop="caigouyuan" class="custom-form-item">
              <el-select v-model="gongYingShang.caigouyuan" filterable placeholder="请选择采购员">
                <!-- types 为后端查询 -->
                <el-option
...
<!--              <el-input ref="acc_inp" v-model="gongYingShang.caigouyuan" class="custom-login-inp"></el-input>-->
          ...
          <el-col :span="6">
            <el-form-item label="兼做客户" prop="jianzuoKehu" class="custom-form-item">
              <el-select v-model="gongYingShang.jianzuoKehu" filterable placeholder="请选择兼做客户">
                <!-- types 为后端查询 -->
                <el-option
          ...
          <el-row :gutter="15">
            ...
            <el-col :span="6">
              <el-form-item label="类型" prop="type" class="custom-form-item">
                <el-select :index="index" @change="selectLeiXing(index,value)" v-model="gongYingShang.body[index].type" filterable placeholder="请选择联系人类型">
                  <!-- types 为后端查询 -->
                  <el-option
    ...
    <el-dialog title="修改供应商" :visible.sync="updDialog">
      ...
      <el-form :model="gongYingShang" ref="addUsr" label-width="100px"
        ...
        <el-row :gutter="15">
          <el-col :span="10">
            <el-form-item label="编号" prop="bianhao" class="custom-form-item">
              <el-input ref="acc_inp" v-model="gongYingShang.bianhao" class="custom-login-inp"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item label="名称" prop="name" class="custom-form-item">
