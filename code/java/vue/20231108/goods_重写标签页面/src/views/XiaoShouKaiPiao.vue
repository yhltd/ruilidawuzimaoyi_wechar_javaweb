<template>
  <el-container style="height: 100%;" direction="vertical">
    ...
    <el-main refs="main" style="height: 50%;margin-top: 20px">
      <el-table
          border
        ...
        <el-row :gutter="15">
          <el-col :span="6">
            <el-form-item label="出库单号" prop="xiaoshouBianhao" class="custom-form-item">
              <el-input ref="acc_inp" @click.native="selectProduct()" readonly="true" v-model="gongYingShang.xiaoshouBianhao" class="custom-login-inp" placeholder="点击选择出库单"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="收票单位" prop="shoupiaoDanwei" class="custom-form-item">
              <el-select style="z-index:999;" v-model="gongYingShang.shoupiaoDanwei" clearable filterable placeholder="请选择收票单位">
                <!-- types 为后端查询 -->
                <el-option
                    v-for="item in XiaLa_KeHu"
                    :key="item.name"
          ...
          <el-col :span="10"><!--  ztt修改宽度-->
            <el-form-item label="开票单位" prop="kaipiaoDanwei" class="custom-form-item">
              <el-select style="z-index:999;" v-model="gongYingShang.kaipiaoDanwei" clearable filterable placeholder="请选择开票单位">
                <!-- types 为后端查询 -->
                <el-option
                    v-for="item in XiaLa_HeSuanDanWei"
                    :key="item.name"
          ...
          <el-col :span="6">
            <el-form-item label="信息推送" prop="xinxiTuisong" class="custom-form-item">
              <el-select style="z-index:999;" v-model="gongYingShang.xinxiTuisong" clearable filterable placeholder="请选择信息推送">
                <!-- types 为后端查询 -->
                <el-option
    ...
    <el-dialog title="" :visible.sync="selProduct" width="80%">
      ...
      <el-row :gutter="15" style="margin-bottom:10px">
        ...
        <el-col :span="5">
          <el-select style="z-index:999;" v-model="Prokehu" clearable filterable placeholder="请选择客户">
            <!-- types 为后端查询 -->
            <el-option
                v-for="item in XiaLa_KeHu"
                :key="item.name"
    ...
    <el-drawer
      ...
      <el-form :model="gongYingShang" ref="addUsr" label-width="100px"
        ...
        <el-row :gutter="15">
          <el-col :span="10">
            <el-form-item label="出库单号" prop="xiaoshouBianhao" class="custom-form-item">
              <el-input ref="acc_inp" v-model="gongYingShang.xiaoshouBianhao" class="custom-login-inp1" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item label="收票单位" prop="shoupiaoDanwei" class="custom-form-item">
          ...
          <el-col :span="10">
            <el-form-item label="纳税人识别号" prop="shibiehao" class="custom-form-item">
              <el-input ref="acc_inp" v-model="gongYingShang.shibiehao" class="custom-login-inp1" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item label="开票地址" prop="kaipiaoDizhi" class="custom-form-item">
              <el-input ref="acc_inp" v-model="gongYingShang.kaipiaoDizhi" class="custom-login-inp1" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item label="开票电话" prop="kaipiaoDianhua" class="custom-form-item">
              <el-input ref="acc_inp" v-model="gongYingShang.kaipiaoDianhua" class="custom-login-inp1" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item label="开户银行" prop="kaipiaoYinhang" class="custom-form-item">
              <el-input ref="acc_inp" v-model="gongYingShang.kaipiaoYinhang" class="custom-login-inp1" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item label="银行账号" prop="kaipiaoZhanghao" class="custom-form-item">
              <el-input ref="acc_inp" v-model="gongYingShang.kaipiaoZhanghao" class="custom-login-inp1" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item label="开票日期" prop="kaipiaoRiqi" class="custom-form-item">
...
export default {
  ...
  methods: {
    ...
    seeList(row){
      this.p_id = row.id
      let url = "http://yhocn.cn:8102/kaiPiao/selectXiaoShouById"
    ...
    addUser() {
      ...
      this.gongYingShang = {
        ...
        beizhu:'',
        kaipiaoDanwei:'',
        xinxiTuisong:this.userInfo.shenpi,
        kaipiaoZhuangtai:'待开票',
      }
      this.addDialog = true;
    },
    ...
    //查询窗口table中的内容列表
    getCaiGouProduct(){
      let url = "http://yhocn.cn:8102/kaiPiao/selectYingKai"
    ...
    getUser(){
      ...
      this.axios.post(poweruUrl,{"name":this.userInfo.power}).then(res => {
        if(res.data.code == '00') {
          ...
          // <!--    ztt 导航栏快速跳转未审核-->
          this.shuju = this.$route.query.xiaoshoukaipiaogeshu
    ...
    getAll(){
      ...
      let url = "http://yhocn.cn:8102/kaiPiao/getAll"
    ...
    queryList(){
      ...
      let url = "http://yhocn.cn:8102/kaiPiao/queryList"
    ...
    saveGongYingShang(){
      ...
      let url = "http://yhocn.cn:8102/kaiPiao/kaiPiaoAdd"
    ...
    updGongYingShang(){
      var save_list = this.gongYingShang
      let url = "http://yhocn.cn:8102/kaiPiao/kaiPiaoUpd"
      this.axios.post(url, save_list).then(res => {
        if(res.data.code == '00') {
          console.log(res)
          MessageUtil.success(res.data.msg);
    ...
    deleteClick(){
      ...
      this.$confirm('是否删除当前选中的信息?', '提示', {
        ...
        console.log(list)
        let url = "http://yhocn.cn:8102/kaiPiao/delKaiPiao";
    ...
    kaiPiaoClick(){
      ...
      this.$confirm('是否对当前选中的信息开票?', '提示', {
        ...
        console.log(list)
        let url = "http://yhocn.cn:8102/kaiPiao/kaiPiao";
        axios.post(url, {"list": list}).then(res => {
          MessageUtil.success(res.data.msg);
          this.query()
        }).catch(() => {
    ...
    getfileList(row){
      ...
      this.axios.post(url, {"id":row.id,"type":"销售开票"}).then(res => {
        if(res.data.code == '00') {
    ...
    refreshfileList(){
      let url = "http://yhocn.cn:8102/fileTable/getAll"
      this.axios.post(url, {"id":this.p_id,"type":"销售开票"}).then(res => {
        if(res.data.code == '00') {
          this.FileList = res.data.data;
          this.fileDialog = true
          MessageUtil.success("共查询到" + this.FileList.length + "条数据")
